...
namespace MyNote.Identity.API.Migrations
{
    ...
    [Migration("20171210101730_DomainEvents")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyNote.Infrastructure.Model.DomainEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("MyNote.Infrastructure.Model.DomainEvent", b =>
                {
                    b.HasOne("MyNote.Identity.Domain.Model.Company")
                    ...
                    b.HasOne("MyNote.Identity.Domain.Model.Project")
                        .WithMany("DomainEvents")
                        .HasForeignKey("ProjectId");

                    b.HasOne("MyNote.Identity.Domain.Model.Resource")
                        .WithMany("DomainEvents")
                        .HasForeignKey("ResourceId");

                    b.HasOne("MyNote.Identity.Domain.Model.Team")
                        .WithMany("DomainEvents")
                        .HasForeignKey("TeamId");

                    b.HasOne("MyNote.Identity.Domain.Model.User")
                        .WithMany("DomainEvents")
                        .HasForeignKey("UserId");
                });
